...
document.addEventListener("DOMContentLoaded", (e)=>{
    document.getElementById('vote').addEventListener("click", (e)=>{
        ...
        if(!Number(input_num)){
            //alert("文字が入力されています");
            document.getElementById("error_message").innerHTML="文字が入力されています";
            return;
        }
        ...
        if(String(input_num).length!=4){
            ...
            document.getElementById("error_message").innerHTML="４桁の数字を入力してください";
            return;
        }
        ...
        if(n[0]==n[1] || n[0]==n[2] || n[0]==n[3] || n[1]==n[2] || n[1]==n[3] || n[2]==n[3]){
            ...
            document.getElementById("error_message").innerHTML="ユニークな数字を入力してください";
            return;
        }
